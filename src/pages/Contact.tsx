          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <a href="mailto:bookings@classiqdjfaze.ng" className="flex items-center gap-4 text-muted-foreground text-sm hover:text-primary transition-colors">
                  <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                  bookings@classiqdjfaze.ng
                </a>
                <a href="mailto:info@classiqdjfaze.ng" className="flex items-center gap-4 text-muted-foreground text-sm hover:text-primary transition-colors">
                  <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                  info@classiqdjfaze.ng
                </a>
                <a href="tel:08034478512" className="flex items-center gap-4 text-muted-foreground text-sm hover:text-primary transition-colors">
                  <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                  08034478512
                </a>
                <a href="tel:08087412512" className="flex items-center gap-4 text-muted-foreground text-sm hover:text-primary transition-colors">
                  <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                  08087412512
                </a>
                <a href="https://classiqdjfaze.ng" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-muted-foreground text-sm hover:text-primary transition-colors">
            ...
            <div className="bg-card border border-border rounded-lg p-4 flex justify-center">
              <div ref={twitterRef}>
                <a
                  ...
                  data-height="600"
                  data-width="500"
                  href="https://twitter.com/classiqdjfaze"
                >
